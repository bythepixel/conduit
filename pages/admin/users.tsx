                ...
                <div className="grid grid-cols-1 md:grid-cols-[30%_1fr] gap-8">
                    ...
                    <div>
                        ...
                        <button
                            ...
                            title="Sync all users from Slack"
                        >
                            {syncing ? (
                                <>
                    ...
                    <div>
                        ...
                        {loading ? (
                            ...
                            const filteredUsers = users.filter(u => {
                                ...
                                const slackId = u.slackId?.toLowerCase() || ''
                                return firstName.includes(searchLower) || 
                                       lastName.includes(searchLower) || 
                                       email.includes(searchLower) || 
                                       slackId.includes(searchLower) ||
                                    ...
                                    <div key={u.id} className="group bg-slate-800 p-3 rounded-lg shadow-sm border border-slate-700 flex justify-between items-center hover:shadow-md transition-all">
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center gap-2 flex-wrap">
                                                ...
                                                {u.slackId && (
                                                    <p className="text-slate-500 text-xs font-mono">{u.email ? '• ' : ''}{u.slackId}</p>
                                                )}
                                                {!u.email && !u.slackId && (
